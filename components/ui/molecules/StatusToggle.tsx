...
export const StatusToggle: React.FC<StatusToggleProps> = ({ isWaiting, onChange, label = "Statut", className = "" }) => {
  return (
      ...
      <div className="flex bg-slate-100 p-1 rounded-lg">
        <button
          ...
          className={`flex-1 flex items-center justify-center gap-2 py-2 rounded-md text-sm font-bold transition-all ${
            !isWaiting ? "bg-emerald-500 text-white shadow-sm" : "text-slate-500 hover:text-slate-700 hover:bg-slate-200/50"
          }`}
        >
        ...
        <button
          ...
          className={`flex-1 flex items-center justify-center gap-2 py-2 rounded-md text-sm font-bold transition-all ${
            isWaiting ? "bg-amber-500 text-white shadow-sm" : "text-slate-500 hover:text-slate-700 hover:bg-slate-200/50"
          }`}
        >
