      ...
      {weeks.map((week) => {
        ...
        return (
          ...
          >
            ...
            {/* Badge Contextuel */}
            {count > 0 && (
              <div className={`absolute -top-1.5 -right-1.5 h-5 min-w-[20px] px-1.5 rounded-full flex items-center justify-center text-[10px] font-black shadow-sm animate-in zoom-in duration-300 gap-0.5 ${
                isSearching 
