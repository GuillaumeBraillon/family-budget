      ...
      <div className="bg-white rounded-xl shadow-lg max-w-sm w-full overflow-hidden">
        ...
        <div className="p-6">
          ...
          <div className="flex gap-3 justify-end">
            <button onClick={onCancel} className="px-4 py-2 rounded-lg border border-slate-300 bg-white text-slate-700 font-medium hover:bg-slate-50 text-sm">
              Annuler
            </button>
            <button onClick={onConfirm} className="px-4 py-2 rounded-lg bg-red-600 text-white font-medium hover:bg-red-700 shadow-sm text-sm">
              Supprimer
            </button>
          </div>
        </div>
