...
/**
 * Composant de barre de recherche avec icône centrée.
 * Correction de l'alignement vertical en utilisant un wrapper relatif interne
 * pour éviter que l'icône ne se décale si le conteneur flex parent s'étire.
 */
