...
/**
 * Organisme regroupant les modales d'interaction du Planner.
 */
export const PlannerModals: React.FC<PlannerModalsProps> = ({
  ...
  return (
    <>
      {/* MODALE DE CONFIRMATION DE PAIEMENT / RÉCEPTION */}
      {confirmModal.isOpen && (
      ...
      {/* MODALE D'ANNULATION DE POINTAGE */}
...
// Atome interne spécifique aux formulaires des modales
