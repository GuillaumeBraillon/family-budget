                            ...
                            return (
                                <tr key={idx} className="hover:bg-slate-50 transition-colors group">
                                    ...
                                    <td className="px-3 py-3 text-right text-slate-500">
                                        {m.otherIncome > 0 ? m.otherIncome.toFixed(2) + ' €' : '-'}
                                    </td>
                                    ...
                                    <td className={`px-3 py-3 text-right font-black bg-slate-50/50 group-hover:bg-slate-100 transition-colors ${isPos ? 'text-emerald-600' : 'text-rose-600'}`}>
                                        {isPos ? '+' : ''}{m.balance.toFixed(2)} €
                                    </td>
