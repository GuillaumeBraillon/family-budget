      ...
      <div className="flex-1 flex flex-col justify-between">
          ...
          <div className="flex items-baseline gap-2">
              <span className="text-2xl font-black text-rose-300">
                  {-roundTo0(usedEnvelope)} €
              </span>
              {Math.abs(roundTo0(usedEnvelope) - usedEnvelope) > 0.01 && (
                  <span className="text-[10px] text-slate-500 font-medium">
                      ({(-usedEnvelope).toFixed(2)})
                  </span>
              )}
          </div>
          <div className="mt-2 text-[10px] text-rose-300/70 leading-tight">
              Dépenses variables nettes.
          </div>
      </div>
      ...
      <div className="flex-1 flex flex-col justify-between items-end text-right">
          ...
          <div className="mt-3 flex flex-col items-end gap-1">
               ...
               <div className="flex items-center gap-1 text-[10px] font-medium text-slate-500">
                  Disponible pour les comptes persos
               </div>
          </div>
      </div>
    </div>
