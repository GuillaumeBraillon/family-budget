    ...
    <div className="space-y-6">
      <div className="bg-gradient-to-r from-slate-900 to-indigo-900 text-white rounded-2xl p-5 shadow-xl flex flex-col md:flex-row items-stretch justify-between gap-6 animate-in slide-in-from-top-2 duration-500 border border-white/10">
        ...
        <div className="flex-1 flex flex-col justify-between">
          ...
          <div className="mt-2 text-[10px] text-slate-400 leading-tight">Charges fixes restant à payer.</div>
        </div>
        ...
        <div className="flex-1 flex flex-col justify-between">
          ...
          <div className="mt-2 text-[10px] text-indigo-300/70 leading-tight">Achats CB non encore débités.</div>
        </div>
        ...
        <div className="flex-1 flex flex-col justify-between items-end text-right">
          <div className="flex items-center gap-2 mb-2">
            ...
            <MobileTooltip text={renderTooltipContent(totalDetails)} icon={<Info size={14} className="text-slate-500 hover:text-white" />} widthClass="w-56" />
          </div>
          <div>
            <span className="text-3xl font-black tracking-tighter text-white">{roundTo0(resteAPayer)} €</span>
          </div>
          <div className="mt-3 flex flex-col items-end gap-1">
            ...
            <div className="flex items-center gap-1 text-[10px] font-medium text-slate-500">À couvrir par le compte joint</div>
          </div>
        </div>
      </div>
    </div>
